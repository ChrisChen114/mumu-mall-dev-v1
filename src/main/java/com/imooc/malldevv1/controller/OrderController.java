...
public class OrderController {
    ...
    //前台生成支付二维码
    //视频8-9 二维码接口开发
    //技术点：1）获取到请求属性(ServletRequestAttributes) RequestContextHolder.getRequestAttributes()，拿到http请求HttpServletRequest request = requestAttributes.getRequest()；2）使用QRCodeGenerator组件
    //2022-08-31 创建
    @PostMapping("/qrcode")
